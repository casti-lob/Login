	...
	<body>
		...
		<div align="center">
			...
			for(int i =0;i<list.size();i++){
				...
				element.append("<td><a href='Delete.jsp?key="+list.get(i).getCode()+"'>Borrar</a></td>");
				element.append("<td><a href='Modify.jsp?key="+list.get(i).getCode()+"'>Modificar</a></td>");
				element.append("</tr>");
			}
			element.append("</table>");
			%>
		...
		<div align="center">
			<table>
				<tr align="center">
					<td align="center" colspan="3">
						<h2>AGREGAR</h2>
						<a href="Add.html"><img width="150px"  src="add.png" ></a>			
					</td>
				</tr>
			</table>
		</div>
