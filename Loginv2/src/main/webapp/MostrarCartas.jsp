...
<html>
	...
	<div align="center">
		...
		for(int i =0;i<list.size();i++){
			...
			element.append("<td><a href='eliminar.jsp?key="+list.get(i).getCode()+"'><img width=50px id=delete src=dele.png ></a></td>");
			element.append("<td><a href='modificar.jsp?key="+list.get(i).getCode()+"'><img width=50px id=mod src=mof.png ></a></td>");
			element.append("</tr>");
		}
		element.append("<tr><td align=center colspan=8><h2>AGREGAR</h2><a href=agregar.html><img width=150px  src=add.png ></a>	</td></tr>");
		element.append("</table>");
